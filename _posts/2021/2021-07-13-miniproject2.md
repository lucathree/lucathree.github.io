...
- 프로젝트 발표기한 때문에 강제로 프로젝트를 마무리 시키기는 했지만 원래 기획했던 내용은 모두 구현하지 못했기 때문에 약간의 시간이 흐른 뒤 다시 이 프로젝트로 돌아와 처음에 기획했던 대로 다시 마무리를 할 예정이다.

그 때는 자세한 코드 리뷰까지도 첨부하여 후기를 작성할 수 있도록 하려고 한다.